...
<section className="flex items-center justify-center py-20 bg-white min-w-screen">
    <div className="px-16 bg-white">
        <div className="container flex flex-col items-start mx-auto lg:items-center">
            ...
            <h2 className="relative flex items-start justify-start w-full max-w-3xl text-3xl font-bold lg:justify-center">
                ...
                See what our customers are saying</h2>
            ...
            <div className="items-center justify-center w-full mt-12 mb-4 lg:flex">
                <div className="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
                    <div className="flex items-center justify-center">
                        ...
                        <div className="flex flex-col items-start justify-center">
                            <h4 className="font-bold text-gray-800">Vijay Seth</h4>
                            {/* <p className="text-gray-600">CEO of Something</p> */}
                        </div>
                    </div>
                    <blockquote className="mt-8 text-lg text-gray-500">"Aside from the beautiful building, the cool shirts and mugs and the awesome owners.... the BURGER is killer! Great job, y'all!"</blockquote>
                </div>
                <div className="flex flex-col items-start justify-start w-full h-auto px-0 mx-0 mb-12 border-l border-r border-transparent lg:w-1/3 lg:mb-0 lg:px-8 lg:mx-8 lg:border-gray-200">
                    <div className="flex items-center justify-center">
                        ...
                        <div className="flex flex-col items-start justify-center">
                            <h4 className="font-bold text-gray-800">Afrin</h4>
                            {/* <p className="text-gray-600">CTO of Business</p> */}
                        </div>
                    </div>
                    <blockquote className="mt-8 text-lg text-gray-500">"Loved it! Friendly people, beautiful artwork, comfy sofas and great food! We will be back"</blockquote>
                </div>
                <div className="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
                    <div className="flex items-center justify-center">
                        ...
                        <div className="flex flex-col items-start justify-center">
                            <h4 className="font-bold text-gray-800">Sherif Raza</h4>
                            {/* <p className="text-gray-600">Creator of Stuff</p> */}
                        </div>
                    </div>
                    <blockquote className="mt-8 text-lg text-gray-500">"Great ambience, excellent food & drinks and friendly staff - a combination for success! This is a venture I can endorse without reservation"</blockquote>
                </div>
            </div>
        </div>
    </div>
